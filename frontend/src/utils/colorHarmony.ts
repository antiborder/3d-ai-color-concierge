...
export type HarmonyMode = 'none' | 'complementary' | 'triangle' | 'square' | 'pentagon' | 'hexagon' | 'heptagon' | 'octagon' | 'nonagon';
...
function hueOffsets(mode: HarmonyMode): number[] {
  switch (mode) {
    ...
    case 'heptagon':      return [360/7, 720/7, 1080/7, 1440/7, 1800/7, 2160/7].map(Math.round);
