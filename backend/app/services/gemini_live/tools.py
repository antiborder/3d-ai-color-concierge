...
def tool_call_to_frontend_command(name: str, args: dict) -> dict:
    ...
    elif name == "SELECT_BRIDGE_POSITION":
        cmd["parameters"] = {
            ...
            "function_declarations": [
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "amount": {
                                "type": "number",
                                "minimum": 0,
                                "description": "Absolute adjustment amount on a 0-100 scale for brightness/saturation (e.g., 10 means add/subtract 10 points), or 0-360 scale for hue. When user says '10%', use 10 (absolute points), NOT a fraction of the current value. Default is 10 if not specified.",
                            },
                        },
                ...
                },
                {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "spectral12": {
                                "type": "boolean",
                                "description": "Spectral 12 colors",
                            },
                            "japanese": {
                                "type": "boolean",
                ...
                },
                {
                    ...
                    "description": (
                        ...
                        "Before calling this, you can call GET_CURRENT_COLOR to see the current bridgeColorA and bridgeColorB values."
                    ),
                    "parameters": {
                        "type": "object",
                        "properties": {
