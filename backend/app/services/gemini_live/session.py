...
class GeminiLiveSession:
    ...
    async def __aenter__(self) -> "GeminiLiveSession":
        ...
        if sdk_debug_enabled() and (not self._did_log_sdk_debug):
            ...
            try:
                ...
                if allow_reconnect and (
                    ...
                    try:
                        ...
                        if callable(fn2):
                            await await_if_needed(fn2(audio=blob_payload or dict_bytes))
                            return None
                    except Exception:
                        pass
                return (e, e2)
                    ...
                    if sc is not None:
                        ...
                        if txt:
                            ...
                            if transcription_source in ("output_transcription", "output_audio_transcription"):
                                ...
                                self._out_transcription_buf = merge_streaming_text(
                        ...
                        if it_txt:
                            ...
                            self._in_transcription_buf = merge_streaming_text(
